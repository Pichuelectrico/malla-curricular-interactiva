...
```bash
git remote add encore encore://malla-curricular-interactiva-hayi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/malla-curricular-interactiva-hayi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/malla-curricular-interactiva-hayi/settings/integrations/github)

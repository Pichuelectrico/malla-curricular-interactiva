 ...
 */
import { loadProgress as api_progress_load_loadProgress } from "~backend/progress/load";
import { saveProgress as api_progress_save_saveProgress } from "~backend/progress/save";
...
export namespace progress {
    ...
    export class ServiceClient {
        ...
        public async loadProgress(params: { curriculumId: string }): Promise<ResponseType<typeof api_progress_load_loadProgress>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/progress/load/${encodeURIComponent(params.curriculumId)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_progress_load_loadProgress>
        }

        public async saveProgress(params: RequestType<typeof api_progress_save_saveProgress>): Promise<void> {
            await this.baseClient.callTypedAPI(`/progress/save`, {method: "POST", body: JSON.stringify(params)})
        }
    }
}
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { getUserInfo as api_user_me_getUserInfo } from "~backend/user/me";
...
export namespace user {
    ...
    export class ServiceClient {
        ...
        public async getUserInfo(): Promise<ResponseType<typeof api_user_me_getUserInfo>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/user/me`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_user_me_getUserInfo>
        }
    }
}

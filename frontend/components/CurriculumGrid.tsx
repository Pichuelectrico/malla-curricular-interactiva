...
export default function CurriculumGrid() {
  ...
  const allCoursesCompleted =
    ...
    completedCourses.size === curriculumData.courses.length;
  ...
  const courseProgress =
    totalCourses > 0 ? (completedCoursesCount / totalCourses) * 100 : 0;
    ...
    <div className="container mx-auto p-4 space-y-6 relative">
              ...
              <div className="flex items-center justify-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-xl text-blue-100">
                    Ahora puedes marcar Writing Intensive
                  </p>
                </div>
              </div>
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-600 dark:text-gray-300">
          Haz clic en las asignaturas para marcarlas como completadas
        </p>
      </div>
          ...
          {(hasCompletedFiveSemesters || allEnglishCompleted) && hasESL0006 && (
            <div
              className={`border-t pt-4 dark:border-gray-600 transition-all duration-500 ${
                allEnglishCompleted
                  ? "bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border-2 border-blue-200 dark:border-blue-700"
                  : ""
              }`}
            >
              <div className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setHasWritingIntensive(checked as boolean)
                  }
                />
                <label
              ...
              {allCoursesCompleted && !hasWritingIntensive && (
                <p className="text-sm text-amber-600 dark:text-amber-400 mt-2 flex items-center">
                  ...
                  Debes completar el requisito de Writing Intensive para
                  graduarte
                </p>
              )}
              {allEnglishCompleted && !hasWritingIntensive && (
                <p className="text-sm text-blue-600 dark:text-blue-400 mt-2 flex items-center">
                  ...
                  ¡Has completado todos los niveles de inglés! Ahora puedes
                  marcar este requisito.
                </p>
              )}
            </div>
          )} */}
      ...
      <Card className="dark:bg-gray-800 dark:border-gray-700">
        ...
        <CardContent>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
            Mantén presionado Shift y haz clic para seleccionar múltiples
            asignaturas
          </p>
        </CardContent>
      </Card>
      ...
      <div className="text-center relative">
        <h2
          className={`text-2xl font-bold py-4 px-6 rounded-lg border-2 transition-all duration-500 ${
            isAllCompleted
      ...
      <div className="space-y-8">
        {blockOrder.map((blockName) => {
          ...
          const blockCompletedCredits = blockCourses
            .filter((course) => completedCourses.has(course.id))
            .reduce((sum, course) => sum + course.credits, 0);
          const blockTotalCredits = blockCourses.reduce(
            (sum, course) => sum + course.credits,
            0
          );
          const blockProgress =
          ...
          return (
            <div key={blockName} className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                >
                  {blockCompletedCredits}/{blockTotalCredits} créditos (
                  {blockProgress.toFixed(0)}%)
                </Badge>
              </div>
